...
* Il ruolo **Responsabile della distribuzione** può [configurare un set di percorsi di contenuto che verranno invalidati o svuotati dalla cache Dispatcher dell&#39;AEM quando viene eseguita una pipeline non di produzione](/help/using/non-production-pipelines.md).
