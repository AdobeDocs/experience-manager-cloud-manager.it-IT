---
title: Note sulla versione per Cloud Manager 2026.9.0
description: Scopri la versione di Cloud Manager 2026.9.0 in Adobe Managed Services.
...
# Note sulla versione 2026.9.0 di Cloud Manager in Adobe Managed Services {#release-notes}

<!-- add "hold: true" to metadata above to be able to commit/merge to Main WITHOUT Publishig -->

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Scopri la versione di [!UICONTROL Cloud Manager] 2026.9.0 in Adobe Managed Services.
...
La data di rilascio per [!UICONTROL Cloud Manager] 2026.9.0 è giovedì 3 settembre 2026.
<!-- There are no significant new features or bug fixes in the May Cloud Manager release. -->

La prossima versione pianificata è giovedì 1 ottobre 2026.

<!-- SAVE FOR FUTURE POSSIBLE USE There are no significant new features or bug fixes in the May Cloud Manager release. -->

## Novità {#what-is-new}

Non vi sono nuove funzioni significative nella versione di settembre 2026 di Cloud Manager su AMS.
...
* La rigenerazione di una password di accesso al repository ora invalida la vecchia password. In precedenza, la rigenerazione della password di accesso all’archivio Git non invalidava immediatamente la password precedente, lasciando utilizzabili le vecchie credenziali. La rigenerazione della password ora annulla immediatamente la vecchia, garantendo che le credenziali precedenti non possano più essere utilizzate. (CMGR-41820)

* Controlli delle autorizzazioni aggiornati per applicare la proprietà della risorsa. È stato risolto un problema nella modalità di valutazione dei controlli delle autorizzazioni in modo che l’accesso a un programma venga sempre convalidato in base all’organizzazione proprietaria. Ciò rafforza l’isolamento tra le organizzazioni per le operazioni soggette a autorizzazioni. (CMGR-79156)
