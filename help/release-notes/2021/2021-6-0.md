...
La sezione seguente illustra le note generali sulla versione 2021.6.0 di [!UICONTROL Cloud Manager].
...
* Le regole di qualità `CQBP-84` e `CQBP-84--dependencies` sono state consolidate in un’unica regola. Come parte di questo consolidamento, la scansione delle dipendenze identifica più accuratamente i problemi nelle dipendenze di terze parti distribuite nel runtime di AEM.
