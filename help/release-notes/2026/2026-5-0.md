...
Per avere accesso esclusivo alle prossime funzionalità prima del rilascio generale, puoi partecipare ai programmi beta di Cloud Manager.
...
Un nuovo modello di build compila solo i moduli modificati (anziché l’intero archivio) utilizzando il caching a livello di modulo, riducendo i tempi di build. Si applica alle pipeline di qualità del codice e full stack.
