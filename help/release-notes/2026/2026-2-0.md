---
title: Note sulla versione per Cloud Manager 2026.2.0
description: Scopri la versione di Cloud Manager 2026.2.0 su Adobe Managed Services.
...
# Note sulla versione per Cloud Manager 2026.2.0 su Adobe Managed Services {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Scopri la versione di [!UICONTROL Cloud Manager] 2026.2.0 su Adobe Managed Services.
...
La data di rilascio per [!UICONTROL Cloud Manager] 2026.2.0 è giovedì 5 febbraio 2026.

<!-- There are no significant new features or bug fixes in the May Cloud Manager release. -->

La prossima versione pianificata è giovedì 5 marzo 2026.
...
* **Miglioramenti a livello di stabilità, prestazioni e affidabilità**
...
Per ricevere l&#39;accesso anticipato alle prossime funzionalità prima della versione generale, partecipare ai programmi beta di [!UICONTROL Cloud Manager].
...
[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub) è il punto di accesso centrale per AEM, personalizzato in base alle esigenze della tua organizzazione. Fornisci ad Adobe dettagli sulle estensioni dell&#39;interfaccia utente AEM esistenti in modo che possano aiutarti a abilitarle in Experience Hub.
...
Per partecipare, invia un&#39;e-mail a [beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com) con il tuo OrgID Adobe e una breve descrizione della personalizzazione che intendi creare.

### Build più veloci con il caching dei moduli {#quick-build-cm-pipelines}

Un nuovo modello di build compila solo i moduli modificati (anziché l’intero archivio) utilizzando la memorizzazione nella cache a livello di modulo per ridurre i tempi di build. Si applica alle pipeline di qualità del codice, full stack e di solo staging.
...
Per partecipare, invia un&#39;e-mail a [beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com) con il tuo ID organizzazione e l&#39;ID programma di Adobe.

<!-- You can deactivate incremental builds at the pipeline level by setting the property `CM_BUILD_DISABLE_MODULE_CACHING` to `true` (effective during the `BUILD` step). For how to add pipeline variables, see [Pipeline variables](/help/getting-started/build-environment.md#pipeline-variables). -->

## Correzioni di bug {#bug-fixes}

Non vi sono correzioni di bug significativi nella versione di febbraio 2026 di Cloud Manager su AMS.
