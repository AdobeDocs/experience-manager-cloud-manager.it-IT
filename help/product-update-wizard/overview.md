...
La procedura guidata di aggiornamento del prodotto è un’esperienza di aggiornamento guidata e sequenziale alla versione più recente di Adobe Experience Manager 6.5 con Cloud Manager. Semplifica il processo end-to-end e garantisce il rispetto delle best practice di AEM utilizzando il framework CI/CD di Cloud Manager e il test automatizzato incorporato.
...
I clienti che utilizzano Cloud Manager e che possono effettuare l’aggiornamento a AEM 6.5 possono sfruttare la procedura guidata di aggiornamento del prodotto. Per ulteriori informazioni, contatta il rappresentante del successo dei clienti.

1. Ricevi una notifica push tramite Cloud Manager che ti informa sulla disponibilità di AEM 6.5 per il tuo programma.

1. Una scheda **[!UICONTROL Aggiornamento AEM 6.5]** viene mostrata nella schermata di panoramica di [!UICONTROL Cloud Manager]. Questa scheda tiene traccia della fase corrente del processo di aggiornamento e ti informa del passaggio successivo richiesto.
