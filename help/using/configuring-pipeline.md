...
Il nome utente e la password sono specificati come Variabili [](create-an-application-project.md#pipeline-variables) tubazione con i nomi `CM_PERF_TEST_BASIC_USERNAME` e `CM_PERF_TEST_BASIC_PASSWORD` .
