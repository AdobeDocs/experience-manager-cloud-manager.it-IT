...
# Informazioni sull&#39;ambiente di generazione {#build-environment-details}
...
Cloud Manager ora supporta la creazione di progetti per i clienti con Java 8 e Java 11. Per impostazione predefinita, i progetti vengono creati utilizzando Java 8. I clienti che intendono utilizzare Java 11 nei loro progetti possono farlo utilizzando il plug-in [Apache Maven Toolchain Plugin](https://maven.apache.org/plugins/maven-toolchains-plugin/).
...
>[!NOTE]
>I valori `vendor` supportati sono `oracle` e `sun` e i valori `version` supportati sono `1.8`, `1.11` e `11`.
