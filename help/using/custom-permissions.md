...
1. Seleziona il prodotto **Managed Services AEM**.

1. Cerca e istanza con nome corrispondente al pattern `*-cloud-manager` e tocca o fai clic su per gestire utenti e autorizzazioni.
...
1. Il **Modifica autorizzazioni** viene visualizzata la finestra.
   ...
   * Gli elementi delle autorizzazioni assegnate si trovano nella colonna di destra etichettata **Elementi autorizzazione inclusi**.
   ...
   ![Modifica autorizzazioni](/help/assets/edit-permission-items.png)
...
1. Tocca o fai clic su **Aggiungi tutto** nella parte superiore della **Autorizzazioni disponibili** per aggiungere tutte le autorizzazioni. Tocca o fai clic su **Rimuovi tutto** per rimuovere tutte le autorizzazioni selezionate in precedenza.
...
* **Accesso alle informazioni dell’archivio** Questa autorizzazione a livello di tenant/organizzazione consente agli utenti di generare nome utente, password e URL dell’archivio per accedere e contribuire al progetto del cliente.
   ...
   * Consulta il documento [Archivio del codice sorgente](/help/requirements/source-code-repository.md) per ulteriori informazioni.
...
* A [è disponibile un set limitato di autorizzazioni](#configurable-permissions) per creare profili personalizzati.
...
### Cosa succede se dispongo sia di programmi AEM as a Cloud Service che AMS nella stessa organizzazione IMS? Posso gestire le autorizzazioni da un profilo? {#ams-and-aemaacs}

Devi creare un profilo separato per ciascun tipo di prodotto (ad esempio uno per AEM come Cloud Service e uno per Adobe Managed Services o AMS).
