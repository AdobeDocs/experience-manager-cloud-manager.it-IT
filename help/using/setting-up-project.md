...
description: Segui questa pagina per apprendere come impostare un progetto
...
## Sviluppare il codice in base alle best practice {#develop-your-code-based-on-best-practices}
 ...
 team di progettazione e consulenza di Adobe hanno sviluppato un [set completo di best practice per AEM sviluppatori](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/best-practices.html).
