...
* **Informazioni** : si tratta di problemi identificati dal gate che sono forniti esclusivamente a scopo informativo e non hanno alcun impatto sull&#39;esecuzione della conduttura.
...
| Valutazione affidabilità | A = 0 Bug <br/>B = almeno 1 Bug Minore <br/>C = almeno 1 Bug Principale <br/>D = almeno 1 Bug Critico<br/>E = almeno 1 Bug Blocco | Importante | &lt; C |
...
| La replica non utilizza l&#39;utente &#39;admin&#39; | Utenti replica e trasporto | Informazioni |
...
Per ulteriori informazioni sui controlli del bucket, vedere [Configurare la pipeline CI/CD](configuring-pipeline.md).

>[!NOTE]
>
>Per impostare il programma e definire i KPI, vedere [Configurazione del programma](setting-up-program.md).
...
| Richieste al minuto | Informazioni | >= 6000 |

### Grafici dei risultati delle prove delle prestazioni {#performance-testing-results-graphs}
...
Per [!UICONTROL Cloud Manager] Release 2018.7.0, questa funzionalità è disponibile per le metriche seguenti:
